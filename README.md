...
orchestrate-command-status/0.0.23 darwin-x64 node-v16.5.0
...
_See code: [src/commands/run.ts](https://github.com/lakshmiravali/orchestrator/blob/v0.0.23/src/commands/run.ts)_
<!-- commandsstop -->
